'''
Script to plot results from ratio-bern-linear experiment
(varying ratio btw indirect/direct effects; bernoulli RD; linear model)
'''
# Setup
...
experiment = "-ratio-bern-linear" # vary ratio; bernoulli RD; linear model
